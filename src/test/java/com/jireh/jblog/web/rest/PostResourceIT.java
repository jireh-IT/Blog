...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).author(DEFAULT_AUTHOR).body(DEFAULT_BODY);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().title(UPDATED_TITLE).author(UPDATED_AUTHOR).body(UPDATED_BODY);
        return post;
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).author(UPDATED_AUTHOR).body(UPDATED_BODY);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).author(UPDATED_AUTHOR).body(UPDATED_BODY);
